...
/**
 * Created by joaor on 25/04/2016.
 */
public class Usuario {

    private String RazaoSocial,nome,sobrenome,cpf,cnpj,email,telefone,celular,endereco,bairro,cidade,estado,complemento,cep,nomeSolicitante, cpfSolicitante;
    private int pfpj;
